...
import com.exequieltiglao.nothing.R
import com.exequieltiglao.nothing.RootLifeCycleEvent
...
class RootBuilder(dependency: ParentComponent) : ViewBuilder<RootView, RootRouter, RootBuilder.ParentComponent>(dependency) {
     ...
     */
    fun build(parentViewGroup: ViewGroup, rootActivity: Activity, androidEventService: AndroidEventService, rootLifeCycleEvent: Observable<RootLifeCycleEvent>): RootRouter {
        ...
        val component = DaggerRootBuilder_Component.builder()
            ...
            .rootLifeCycleEvent(rootLifeCycleEvent)
    ...
    interface Component : InteractorBaseComponent<RootInteractor>, BuilderComponent {
        ...
        interface Builder {
            ...
            @BindsInstance
            fun rootActivity(rootActivity: Activity) : Builder

            @BindsInstance
            fun androidEventService(androidEventService: AndroidEventService) : Builder

            @BindsInstance
            fun rootLifeCycleEvent(rootLifeCycleEvent: Observable<RootLifeCycleEvent>) : Builder
